...
/**
 * Test utility for interacting with Kafka channels backed by
 * {@link InMemoryConnector}.
 *
 * <p>This helper simplifies sending messages to input channels,
 * waiting for emitted messages on output channels, and clearing
 * collected messages between test cases.</p>
 *
 * <p>Primarily intended for integration and component tests using
 * SmallRye Reactive Messaging with in-memory connectors.</p>
 */
...
public class KafkaConnector
{
   ...
   /**
    * Creates a new {@code KafkaConnector} using the provided
    * in-memory connector.
    *
   ...
   /**
    * Waits until at least one message has been received on the
    * specified sink channel.
    *
    ...
    *
    * <p>The payload is forwarded through the in-memory connector
    * as if produced to Kafka.</p>
    *
